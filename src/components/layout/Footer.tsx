...
const contactInfo = [
  ...
  { icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", text: "info@morningstargroup of schools.edu" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <Image src="/images/logo.png" alt="Morning Star group of schools" width={48} height={48} className="w-12 h-12 object-contain brightness-200" />
              <div>
                <span className="font-bold text-lg block">Morning Star</span>
                <span className="text-xs text-white/60 tracking-wider uppercase">group of schools</span>
              </div>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-accent mb-4 text-sm uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-accent mb-4 text-sm uppercase tracking-wider">Contact Us</h3>
            <ul className="space-y-3">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} Morning Star group of schools. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            {["facebook", "instagram", "twitter"].map((social) => (
              <a key={social} href="#" className="text-white/50 hover:text-accent transition-colors" aria-label={social}>
